  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 text-slate-900">
      <main className="p-4 max-w-7xl mx-auto">
        ...
        <nav className="sticky top-1 w-full bg-slate-50 p-4 rounded-2xl border transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-pointer/90 backdrop-blur border-b z-50">
          ...
          {/* Mobile Menu */}
          <div className={`md:hidden ${isOpen ? "block" : "hidden"} border-t border-slate-100`}>
        ...
        <div className="w-full mx-auto p-4 md:p-8">
          ...
          <section id="about" className="w-full mx-auto py-6 pb-10">
          ...
          <section className="w-full mx-auto pb-10 md:pb-20">
          ...
          <section id="highlights" className="w-full mx-auto pb-10 md:pb-20">
          ...
          <section className="w-full mx-auto pb-10 md:pb-20">
            ...
            <div className="bg-slate-50 p-8 rounded-2xl border">
              ...
              <button className="bg-blue-900 text-white px-6 py-3 rounded-xl">
                <Link href="#achievements">View Certificate Portfolio</Link>
              </button>
          ...
          <section id="achievements" className="w-full mx-auto pb-10 md:pb-20">
            <h2 className="text-4xl font-bold text-slate-900 mb-10">
              Achievements
            </h2>
          ...
          <section
            id="contact"
            className="w-full mx-auto pb-10 md:pb-20"
          >
            <h2 className="text-4xl font-bold text-slate-900 mb-10">
              Contact
            </h2>
